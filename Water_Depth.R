...
filter(`Date Time`<"2022-01-11 10:00:00")  
...
mutate(`Inflow Est. Water Depth`=`G378C_T_STG_ft NGVD29`/3.28084-3,`Outflow Est. Water Depth`=`G379B_H_STG_ft NGVD29`/3.28084-3)  %>%
...
# Figures -----------------------------------------------------------------
ggplot(Water_Depth_Data,aes(`Date Time`,level,color=Site,fill=Site))+geom_line()+#geom_point(shape=21)+
