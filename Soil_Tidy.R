...
Physical_Parameters_tidy <- Physical_Parameters %>%
...
mutate(`Storage (g/m^2)`=`Bulk Density`*as.numeric(CORE_LENGTH))



# Save Data ---------------------------------------------------------------

write.csv(Physical_Parameters_tidy , "./Data/Soils Data/Soils_Data_Tidy.csv",row.names = FALSE)
